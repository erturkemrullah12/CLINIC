...
const testimonials = [
  {
    ...
    text: "The results are so subtle yet transformative. My friends keep saying I look well-rested, but they can't tell I've had anything done. Precisely what I wanted.",
  ...
  },
  {
    ...
    text: "Professionalism at its peak. The consultation was thorough, and I felt completely at ease. The clinical environment is immaculate and very welcoming.",
  ...
  },
  {
    ...
    text: "I've visited many clinics in London, but Aser Clinic is by far the most expert. Their eye for facial harmony is unmatched in the industry today.",
    ...
    <section className="w-full py-24 bg-nude-light" id="testimonials">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          <span className="text-gold-accent font-bold uppercase tracking-[0.2em] text-xs">Patient Stories</span>
          <h2 className="text-[#1c190d] text-4xl font-black mt-2">What Our Clients Say</h2>
        </div>
