...
const treatments = [
  {
    id: 1,
    title: "Botox",
    description: "Hassas anti-wrinkle enjeksiyonlarımızla ince çizgileri yumuşatın, kırışıklıkları önleyin; dinlenmiş ve genç bir görünüm.",
  ...
  {
    id: 2,
    title: "Dermal Dolgular",
    description: "Premium hyaluronik asit dolgularıyla hacim kazandırın, size özel yüz konturlarınızı güçlendirin.",
  ...
  },
  {
    id: 3,
    title: "PRP Tedavisi",
    description: "Trombositten zengin plazma terapisiyle vücudunuzun doğal iyileşme gücünü kullanın; yenilenme ve saç tedavisi.",
  ...
  },
  {
    id: 4,
    title: "Cilt Yenileme",
    description: "Doku, ton ve genel cilt sağlığını iyileştirmek için ileri kimyasal peeling ve mikroneedling tedavileri.",
  ...
  },
  {
    ...
    description: "Tüy alma, pigment düzeltmesi ve vasküler lezyon giderimi için son teknoloji lazer.",
  ...
  },
  {
    ...
    description: "Klinik uzmanlarımızın seçtiği reçete düzeyinde protokoller ve ürünlerle kalıcı sonuçlar.",
    ...
    <section className="w-full py-24 bg-background-light" id="treatments">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center flex flex-col items-center gap-4 mb-16">
          <span className="text-gold-accent font-bold uppercase tracking-[0.2em] text-xs">Özel Prosedürler</span>
          <h2 className="text-[#1c190d] text-4xl lg:text-5xl font-black tracking-tight">Uzman Hizmetlerimiz</h2>
            ...
            <div key={treatment.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full border border-[#f0ede4]">
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <button 
                  ...
                  Daha Fazla <span className="material-symbols-outlined text-base">arrow_forward</span>
                </button>
              </div>
            </div>
          ))}
