      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 flex flex-col gap-6">
            <span className="text-gold-accent font-bold uppercase tracking-[0.2em] text-xs">The Transformation</span>
            <h2 className="text-[#1c190d] text-4xl lg:text-5xl font-black tracking-tight leading-tight">
              Visible Results, <br/>Invisible Effort
            </h2>
            <p className="text-[#5c5847] text-lg leading-relaxed">
              View our gallery of real transformations. We focus on enhancing your features while ensuring you still look like yourself—only more rested and rejuvenated.
            </p>
            <div className="flex gap-4 pt-4">
              <div className="flex flex-col">
                <span className="text-3xl font-black text-gold-accent">98%</span>
                <span className="text-xs uppercase font-bold text-[#9c8e49] tracking-widest">Client Satisfaction</span>
              </div>
              <div className="w-px h-12 bg-[#e8e4ce]"></div>
              <div className="flex flex-col">
                <span className="text-3xl font-black text-gold-accent">5k+</span>
                <span className="text-xs uppercase font-bold text-[#9c8e49] tracking-widest">Procedures Done</span>
              </div>
            </div>
          </div>
          <div className="lg:w-1/2 w-full">
            ...
            >
              <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: 'url(\'https://lh3.googleusercontent.com/aida-public/AB6AXuDmv9Qxs_stnL1rsfQM-BMlEHukuE5FS_RX9jhr-s73bPEoKcfYyf-kbYPPsnXyCl_f-kfIOMCvYJY95rudU7LRGLZ04qx8VIyfyXtlSCJqhx1fTy3PFbICDCqYXVZmndMDvwf-ORg9TTPPmShuRNEHJqndwxiztFAEjL8xIcMWLGvEtR33N4kX8GRsU6WmhRTXEA8PSKRjhgpO9OiXdP4V9VFNjZZYW1Sw2EbZ_yg6j6CtbGUJvfUt374JueZiH-dyiEBQIujvkUn_\')'}}>
                <span className="absolute top-4 left-4 bg-black/50 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase">Before</span>
              </div>
              <div 
              ...
              >
                <span className="absolute top-4 left-4 bg-primary text-[#1c190d] text-[10px] font-bold px-3 py-1 rounded-full uppercase">After</span>
              </div>
              <div 
            ...
            <p className="text-center mt-6 text-sm italic text-[#5c5847]">*Individual results may vary based on physiological factors.</p>
          </div>
        </div>
      </div>
    </section>
