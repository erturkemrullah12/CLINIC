...
function Hero({ onExploreTreatments, onBookConsultation }) {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-8 max-w-2xl">
          <div className="flex flex-col gap-4">
            <span className="text-gold-accent font-bold uppercase tracking-[0.2em] text-xs">Estetikte Mükemmellik</span>
            <h1 className="text-[#1c190d] text-5xl md:text-7xl font-black leading-[1.1] tracking-[-0.03em]">
              Doğal <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1c190d] to-[#9c8e49]">Güzelliğinizi</span> <br/>
              Güvenle Keşfedin
            </h1>
            <p className="text-[#5c5847] text-lg md:text-xl font-medium leading-relaxed max-w-lg">
              Uzman yönetiminde, size özel tıbbi estetik. Klinik bilimi ve sanatsal hassasiyeti bir araya getiriyoruz.
            </p>
          </div>
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="flex min-w-[180px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-primary text-[#1c190d] text-base font-bold shadow-lg hover:shadow-xl transition-all"
            >
              Randevu Al
            </button>
            <button 
